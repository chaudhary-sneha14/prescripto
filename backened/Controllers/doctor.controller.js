...
const loginDoctor = async (req, res) => {
  try {
    ...
    if (isMatch) {
      ...
      res.json({ success: true, token, doctorId: doctor._id }); // send doctor ID to frontend (optional)
    } else {
...
//----------------------Api for dashbord for doctor panel------------------------
...
//___________________API FOR UPDATE DOCTOR PROFILE DATA FROM DOCTOR PANEL___________________________
